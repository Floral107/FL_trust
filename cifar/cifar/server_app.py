...
from flwr.server.client_manager import SimpleClientManager, ClientManager, Criterion
from flwr.server.client_proxy import ClientProxy
from typing import Optional

from cifar.task import load_model, get_num_clients, save_global_model, set_seed, SEED

set_seed(SEED)  # Set seed for reproducibility

# Resolved inside server_fn via context.run_config; default stays "fedavg" for backward compat.
_STRATEGY = "fedavg"
