...
path_to_save = os.path.join(BASE_DIR.parent, "420" , "cifar")
...
def load_data(partition_id, num_partitions):
    ...
    # >>> Itt grayscale-elj�k az 5%-ot oszt�lyonk�nt <<<
...
def train_with_proximal(model, x, y, mu, epochs, batch_size, verbose=0, shuffle=False):
    ...
    Call AFTER model.set_weights(global_parameters). Uses the model's compiled
    optimizer/loss so training behavior is otherwise identical to model.fit().
    """
